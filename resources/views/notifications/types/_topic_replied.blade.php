<li class="d-flex @if ( ! $loop->last) border-bottom @endif">
  <div>
    <a href="{{ route('users.show', $notification->data['user_id']) }}">
      <img class="img-thumbnail mr-3" alt="{{ $notification->data['user_name'] }}" src="{{ 'http://avatar86177.oss-cn-hangzhou.aliyuncs.com/'.$notification->data['user_avatar'] }}" style="width:48px;height:48px;" />
    </a>
  </div>
